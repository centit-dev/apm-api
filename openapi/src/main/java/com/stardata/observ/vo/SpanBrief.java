...
public class SpanBrief {
     ...
     */
    public SpanBrief(String traceId, String spanId, String parentSpanId, String serviceName, SpanKind spanKind, NameDisplayPair application, NameDisplayPair platform, String cluster, Long duration) {
    ...
    public SpanBrief timestamp(Long timestamp) {
    ...
    public SpanBrief traceId(String traceId) {
        this.traceId = traceId;
        return this;
    }
    ...
    public SpanBrief spanId(String spanId) {
        this.spanId = spanId;
        return this;
    }
    ...
    public SpanBrief parentSpanId(String parentSpanId) {
        this.parentSpanId = parentSpanId;
        return this;
    }
    ...
    public SpanBrief serviceName(String serviceName) {
        this.serviceName = serviceName;
        return this;
    }
    ...
    public SpanBrief spanName(String spanName) {
    ...
    public SpanBrief spanKind(SpanKind spanKind) {
        this.spanKind = spanKind;
        return this;
    }
    ...
    public SpanBrief software(NameDisplayPair software) {
    ...
    public SpanBrief application(NameDisplayPair application) {
        this.application = application;
        return this;
    }
    ...
    public SpanBrief platform(NameDisplayPair platform) {
        this.platform = platform;
        return this;
    }
    ...
    public SpanBrief cluster(String cluster) {
        this.cluster = cluster;
        return this;
    }
    ...
    public SpanBrief instance(String instance) {
    ...
    public SpanBrief duration(Long duration) {
        this.duration = duration;
        return this;
    }
    ...
    public SpanBrief status(SpanStatus status) {
        this.status = status;
        return this;
    }
    ...
    public SpanBrief logCount(Integer logCount) {
    ...
    public boolean equals(Object o) {
        ...
        SpanBrief spanBrief = (SpanBrief) o;
        return Objects.equals(this.timestamp, spanBrief.timestamp) &&
                Objects.equals(this.traceId, spanBrief.traceId) &&
                Objects.equals(this.spanId, spanBrief.spanId) &&
                Objects.equals(this.parentSpanId, spanBrief.parentSpanId) &&
                Objects.equals(this.serviceName, spanBrief.serviceName) &&
                Objects.equals(this.spanName, spanBrief.spanName) &&
                Objects.equals(this.spanKind, spanBrief.spanKind) &&
                Objects.equals(this.software, spanBrief.software) &&
                Objects.equals(this.application, spanBrief.application) &&
                Objects.equals(this.platform, spanBrief.platform) &&
                Objects.equals(this.cluster, spanBrief.cluster) &&
                Objects.equals(this.instance, spanBrief.instance) &&
                Objects.equals(this.duration, spanBrief.duration) &&
                Objects.equals(this.status, spanBrief.status) &&
                Objects.equals(this.logCount, spanBrief.logCount);
    }
