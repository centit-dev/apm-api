...
/**
 * CreateSpanSnapshotRequest
 */

@JsonTypeName("createSpanSnapshot_request")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class CreateSpanSnapshotRequest {
    ...
    public CreateSpanSnapshotRequest() {
        super();
    }
     ...
     */
    public CreateSpanSnapshotRequest(List<@Valid FieldCondition> fieldConditions, TimeRange timeCondition, QueryForType _for) {
        this.fieldConditions = fieldConditions;
        this.timeCondition = timeCondition;
        this._for = _for;
    }

    public CreateSpanSnapshotRequest fieldConditions(List<@Valid FieldCondition> fieldConditions) {
        this.fieldConditions = fieldConditions;
        return this;
    }

    public CreateSpanSnapshotRequest addFieldConditionsItem(FieldCondition fieldConditionsItem) {
    ...
    public CreateSpanSnapshotRequest statusConditions(List<@Valid StatusCondition> statusConditions) {
        this.statusConditions = statusConditions;
        return this;
    }

    public CreateSpanSnapshotRequest addStatusConditionsItem(StatusCondition statusConditionsItem) {
    ...
    public CreateSpanSnapshotRequest timeCondition(TimeRange timeCondition) {
        this.timeCondition = timeCondition;
        return this;
    }
    ...
    public CreateSpanSnapshotRequest _for(QueryForType _for) {
        this._for = _for;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CreateSpanSnapshotRequest createSpanSnapshotRequest = (CreateSpanSnapshotRequest) o;
        return Objects.equals(this.fieldConditions, createSpanSnapshotRequest.fieldConditions) &&
                Objects.equals(this.statusConditions, createSpanSnapshotRequest.statusConditions) &&
                Objects.equals(this.timeCondition, createSpanSnapshotRequest.timeCondition) &&
                Objects.equals(this._for, createSpanSnapshotRequest._for);
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateSpanSnapshotRequest {\n");
